...
| `output/en/screenshots/screenshot-sensors-annotated.png` | Emotions panel with "Live from micro:bit" call-out. |
...
| `graph-record.gif` | Speech panel with Simulate running — live waveform | Etsy listing slot (secondary) · YouTube community post |
...
| `classroom-poster.html` | A3 poster for classroom wall. "We Make Robots Talk in 16 Voices" + 5 steps. |
...
**Where:** Paste into `talking-robot/index.html` or the hosted live-demo
page (`abourdim.github.io/talking-robot`). Nothing else to do.
...
Output: `output/shared/buyers/TalkingRobot-AS-12345-v1.2.0.zip`
...
**Where:**
- Own GitHub repo like `github.com/abourdim/talking-robot-companion`
- Listed in the Etsy description: "MakeCode extension published — search talking-robot-companion"
...
| URL | What buyer sees |
|---|---|
| `#tab=graph` | Speech panel, ready to Simulate |
| `#main` | Product demo screen |
| `#tab=senses&lang=fr` | Emotions panel in French |

**Where:**
- Etsy description: "→ See the live 3D tab: abourdim.github.io/talking-robot/#tab=board3d"
