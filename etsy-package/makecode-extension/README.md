...
[talking-robot browser app](https://abourdim.github.io/talking-robot/) —
...
2. **Advanced → Extensions → search** `abourdim/talking-robot-companion`
...
That's it. Sensor stream starts, LEDs / emotions / buzzer all respond.
...
declares it, `main.ts` is the example, `talking-robot.ts` is the block
