(function () {
  const RULES = [
    ...
    },
    {
      ...
      "answer": "Talking Robot drives two emotions connected to pins P1 and P2. The Motors tab has sliders for angle control, the Voice Input tab sends directional commands, and the 3D tab mirrors the board's orientation in real time."
    }
  ];
