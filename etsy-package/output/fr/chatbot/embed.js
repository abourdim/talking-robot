(function () {
  const RULES = [
    ...
    },
    {
      ...
      "answer": "Talking Robot pilote deux emotions connectés aux broches P1 et P2. L'onglet Moteurs a des curseurs, l'onglet Manette envoie des commandes directionnelles."
    }
  ];
