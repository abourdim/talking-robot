...
> 🧪 **Live demo**: <https://abourdim.github.io/talking-robot/>
...
- [ ] Final sanity check: does the description's "what you get" list
      exactly match what `TalkingRobot-v1.0.0.zip` actually contains?
...
- [x] ~~Host a live demo on GitHub Pages~~ — done. Live at
      <https://abourdim.github.io/talking-robot/>. Already in the
      listing description.
