...
```
Browser-based BLE control panel for the BBC micro:bit V2 (optional). Sensors, emotions, live graphs, 3D models, and a Voice Input — all from Chrome. No install, no account.
```
