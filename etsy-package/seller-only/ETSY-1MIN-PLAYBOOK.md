...
| 3–10 s | *"The micro:bit drives the emotion. The 3D model mirrors the real robot."* | Tab 6 (animated eyes). Real robot next to the laptop. Buggy in 3D follows. |
| 10–20 s | *"D-pad in the browser → arrows on the LED → commands to the motors."* | Tab 4 (Voice Input). Press ⬆ → LED arrow. Buggy crawls forward. |
