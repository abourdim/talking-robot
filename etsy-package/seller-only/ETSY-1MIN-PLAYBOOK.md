...
```
Browser-based BLE control panel for the BBC micro:bit V2 (optional). Sensors, servos, live graphs, 3D models, and a GamePad — all from Chrome. No install, no account.
```
