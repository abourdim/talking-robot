...
> • 13 emotions: LED Matrix, Sensors, Emotion, Voice Input, Graph, Robot Face, Bench, Settings
...
> The Bluetooth control panel for the BBC micro:bit V2 that turns one $20 board into an entire robotics lab. Draw on the LEDs, watch live sensor graphs, drive a animated eyes with the on-screen gamepad, and record sessions for science class. Browser-based — no installs. Instant download from Etsy. #microbit #classroomresources #stemforkids #robotics #makered
