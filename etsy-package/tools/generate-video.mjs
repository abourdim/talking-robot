 ...
 * After apply-template.mjs substitutes Talking Robot / Talk • Listen • Emote, verify
...
const SCENES = [
  { id: 1, dur: 3,  type: 'title',  text: 'Talking Robot',                   subtitle: 'Talk • Listen • Emote' },
  { id: 2, dur: 7,  type: 'image',  src: 'screenshot-speech.png', effect: 'zoom-in' },
  { id: 3, dur: 10, type: 'image',  src: 'screenshot-ble.png',       effect: 'pan-right' },
  { id: 4, dur: 10, type: 'image',  src: 'screenshot-speech.png',   effect: 'zoom-in' },
  { id: 5, dur: 10, type: 'image',  src: 'screenshot-ble.png',    effect: 'pan-left' },
  { id: 6, dur: 10, type: 'image',  src: 'screenshot-speech.png',  effect: 'zoom-out' },
...
function sceneImage(s, out) {
  ...
  if (!existsSync(src)) {
    // Back-compat fallback to legacy filename (e.g. screenshot-ble.png).
