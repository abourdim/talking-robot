...
const I18N = {
  en: { tagline: 'See the live demo in 30s.', role: 'talking-robot · author', contactLabel: 'Say hi' },
  fr: { tagline: 'Chaque capteur, en direct dans le navigateur.', role: 'auteur · talking-robot', contactLabel: 'Contact' },
  ar: { tagline: 'كل حساس، مباشرةً في المتصفح.', role: 'مؤلف · talking-robot', contactLabel: 'للتواصل' },
};
const T = I18N[LANG];
