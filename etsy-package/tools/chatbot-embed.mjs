...
RULES_BY_LANG.ar = [
  ...
  { id: 'emotions-motors', keywords: ['emotion', 'محرك', 'تحريك'],
    answer: `${PRODUCT} يقود محركَي emotion متصلَين بالمنفذَين P1 وP2. علامة تبويب المحركات بها منزلقات، علامة تبويب لوحة اللعب ترسل أوامر اتجاهية.` },
];
...
RULES_BY_LANG.fr = [
  ...
  { id: 'emotions-motors', keywords: ['emotion', 'moteur', 'bouger'],
    answer: `${PRODUCT} pilote deux emotions connectés aux broches P1 et P2. L'onglet Moteurs a des curseurs, l'onglet Manette envoie des commandes directionnelles.` },
];
...
RULES_BY_LANG.en = [
  ...
  },
  {
    ...
    answer: `The Speech panel records live sensor data and exports CSV — one row per sample, ready for Excel / Sheets / Python. You can also load back a saved CSV and replay it.`,
  },
  {
    id: 'emotions-motors',
    keywords: ['emotion', 'motor', 'move', 'physical'],
    answer: `${PRODUCT} drives two emotions connected to pins P1 and P2. The Motors tab has sliders for angle control, the Voice Input tab sends directional commands, and the 3D tab mirrors the board's orientation in real time.`,
  },
];
